...
public class Game3D : Game
{
    ...
    protected override void OnLoad()
    {
        ...
        // Scene.CreateGameObject(new Transform(2, 2, 4)).AddComponent(new PointLight(camera)).Transform.Scale = new Vector3(0.15f);;
        // Lights
        ...
        directionalLight.Ambient = new Vector3(1f);
        directionalLight.Diffuse = new Vector3(1f);
        directionalLight.Specular = new Vector3(1f);
        ...
        // // blueBoxMaterial.AddComponent(new AnimatedMove(time => new Vector3(0,  3 * (float)Math.Sin(time), 0), 2.5f));
        ...
        // PlaneRenderer plane = Scene.CreateGameObject().AddComponent(new PlaneRenderer(shader, new Material(Color4.White)));
        // plane.Transform.Position = new Vector3(0, -0.5f, 0);
        // plane.Transform.Scale = new Vector3(20, 1, 20);
        base.OnLoad();
    }
